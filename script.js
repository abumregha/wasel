        ...
        <div style="direction: rtl; font-family: 'Noto Sans Arabic', Arial, sans-serif; padding: 20px; background: white; color: black;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 10px 0 20px 0; font-size: 13px;">
                <thead><tr style="background: #007bff; color: white;">
                    <th style="border: 1px solid #000; padding: 10px; text-align: center;">اسم العنصر</th>
                    <th style="border: 1px solid #000; padding: 10px; text-align: center;">السعر</th>
                    <th style="border: 1px solid #000; padding: 10px; text-align: center;">الكمية</th>
                    <th style="border: 1px solid #000; padding: 10px; text-align: center;">الإجمالي</th>
                </tr></thead>
